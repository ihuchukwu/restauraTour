...
Event.create(name:"Tiffany Diner welcomes restauraTour", restaurant_id:1)
Event.create(name:"Moonstruck Restaurant welcomes restauraTour", restaurant_id:2)
Event.create(name:"Relish welcomes restauraTour", restaurant_id:3)
Event.create(name:"Randi's Restaurant and Bar welcomes restauraTour", restaurant_id:4)
Event.create(name:"CinCin welcomes restauraTour", restaurant_id:5)
Event.create(name:"Palace of Asia welcomes restauraTour", restaurant_id:6)
Event.create(name:"ESTIA Diner welcomes restauraTour", restaurant_id:7)
Event.create(name:"Benny The Bums welcomes restauraTour", restaurant_id:8)
