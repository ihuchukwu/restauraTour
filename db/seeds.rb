...
MenuItem.create(name:"Lamb Chops", description:"Charboiled lamb chops with mint jelly",restaurant_id:4)
MenuItem.create(name:"Broilled Salmon", description:"Broilled salmon with lemon butter", restaurant_id:4)
MenuItem.create(name:"Roast Turkey", description:"Roast turkey with stuffing and gravy", restaurant_id:4)
